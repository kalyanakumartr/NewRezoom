...
public interface ProducerPropertyDao extends JpaRepository<ProducersProperty, String>
{
	...
	@Query("Select PP.producer.producerId, PP.value From ProducersProperty PP where PP.producer.producerId = :producerId AND PP.status = true and PP.media = :eMedia and PP.mediaMode = :eMediaMode")
	public List<Object[]> getProperty(@Param("producerId") String producerId, @Param("eMedia") EMedia eMedia, @Param("eMediaMode") EMediaMode eMediaMode);
