...
public abstract class ConfigurationBase implements IConfiguration
{
	...
	{
		_5_Minutes(5), _15_Minutes(15), _30_Minutes(30), _1_Hour(60), _4_Hours(4 * 60), _6_Hours(6 * 60), _12_Hours(12 * 60), //
		_1_Day(24 * 60), _120_Days(120 * 24 * 60), _180_Days(180 * 24 * 60), _2_Hours(2 * 60), //
		_270_Days(270 * 24 * 60), _3_Days(3 * 24 * 60), _30_Days(30 * 24 * 60), _365_Days(365 * 24 * 60), //
		_60_Days(60 * 24 * 60), _90_Days(90 * 24 * 60);
