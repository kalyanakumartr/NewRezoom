...
public interface IPathAdmin extends IPath, IErrorAdmin
{
	...
	public enum EPathAdmin implements EnumResourceInterface
	{
		...
		GetUsersByProducer(GET_USER_BY_CUSTID, ERole.Administrator, ERole.Supervisor),
		...
		GetGroupByProducer(GET_GROUP_BY_CUST_ID, ERole.Administrator, ERole.Supervisor), //
