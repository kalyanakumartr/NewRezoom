...
public interface IKafkaTopicConstants extends IKafkaConstants
{
	...
	{
		Message(MESSAGE_TOPIC), DataExtract(DATA_EXTRACT_TOPIC);
	...
	public enum EPartition implements IKAFKAPartition
	{
