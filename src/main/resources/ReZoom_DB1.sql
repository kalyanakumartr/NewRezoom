...
INSERT INTO `producers` (`producerId`, `producerType`, `producerName`, `pwdExpiryDays`, `domainContext`, `employeeId`, `createdBy`, `createdDate`, `modifiedDate`, `modifiedBy`, `status`, `primary`, `emailId`, `mobileNo`, `phoneNo`, `whatsAppNo`, `description`, `registrationDate`, `customerStatus`) VALUES
	...
	('PRD000002', 'SGProducer', 'EduTel Tambaram', '2017-08-02 07:33:06', '/edutel', 'PRDADM0001', 'PRDADM0001', '2017-08-02 07:33:07', '2017-08-02 07:33:08', 'PRDADM0001', b'1', b'0', NULL, NULL, NULL, NULL, NULL, NULL, 'Pending'),
	('PRD000003', 'SGProducer', 'EduTel Medavakkam', '2017-08-02 07:33:06', '/edutel', 'PRDADM0001', 'PRDADM0001', '2017-08-02 07:33:07', '2017-08-02 07:33:08', 'PRDADM0001', b'1', b'0', NULL, NULL, NULL, NULL, NULL, NULL, 'Pending'),
	('PRD000004', 'SGProducer', 'EduTel Villivakkam', '2017-08-02 07:33:06', '/edutel', 'PRDADM0001', 'PRDADM0001', '2017-08-02 07:33:07', '2017-08-02 07:33:08', 'PRDADM0001', b'1', b'0', NULL, NULL, NULL, NULL, NULL, NULL, 'Pending'),
	('PRD000005', 'SGProducer', 'EduTel Annanagar', '2017-08-02 07:33:06', '/edutel', 'PRDADM0001', 'PRDADM0001', '2017-08-02 07:33:07', '2017-08-02 07:33:08', 'PRDADM0001', b'1', b'0', NULL, NULL, NULL, NULL, NULL, NULL, 'Pending'),
	('PRD000006', 'SGProducer', 'EduTel Madipakkam', '2017-08-02 07:33:06', '/edutel', 'PRDADM0001', 'PRDADM0001', '2017-08-02 07:33:07', '2017-08-02 07:33:08', 'PRDADM0001', b'1', b'0', NULL, NULL, NULL, NULL, NULL, NULL, 'Pending'),
...
CREATE TABLE IF NOT EXISTS `resume_attachments` (
  ...
  `modifiedBy` varchar(50) DEFAULT NULL,
  `status` bit(1) NOT NULL DEFAULT b'1',
  `uploadResourceHandler` varchar(50) NOT NULL,
  `uploadSubFolderPath` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`autoId`)
...
INSERT INTO `resume_attachments` (`autoId`, `resumeURN`, `incomingId`, `trace`, `uploadFileDate`, `uploadFileFolderURL`, `uploadFileLastModifiedDate`, `uploadFileName`, `uploadFileNameForDisplay`, `uploadFileSize`, `uploadDocumentForType`, `createdDate`, `modifiedDate`, `createdBy`, `modifiedBy`, `status`, `uploadResourceHandler`, `uploadSubFolderPath`) VALUES
	...
	(50, NULL, '233fdc19-d47c-47c6-b2e2-5b041e1f7493', 'YetToTrace', '2020-01-22 15:57:13', '/C:\\Users\\HP\\AttachmentPath\\/PRD000001\\PRD000001\\2019-12-26\\160043\\', '2020-01-22 15:57:13', 'IMG-20191224-WA0002.jpg', NULL, 127696, NULL, '2020-01-22 15:57:13', NULL, NULL, NULL, b'1', 'Default', '/PRD000001\\PRD000001\\2019-12-26\\160043\\'),
	(51, NULL, '233fdc19-d47c-47c6-b2e2-5b041e1f7493', 'YetToTrace', '2020-01-22 15:57:20', '/C:\\Users\\HP\\AttachmentPath\\/PRD000001\\PRD000001\\2019-12-26\\160043\\', '2020-01-22 15:57:20', 'IMG-20191224-WA0003.jpg', NULL, 207644, NULL, '2020-01-22 15:57:20', NULL, NULL, NULL, b'1', 'Default', '/PRD000001\\PRD000001\\2019-12-26\\160043\\'),
