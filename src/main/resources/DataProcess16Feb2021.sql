...
-- Dumping data for table data_process.menurole: ~1 rows (approximately)
...
-- Dumping data for table data_process.portletsroles: ~1 rows (approximately)
...
-- Dumping data for table data_process.portletsusers: ~1 rows (approximately)
...
-- Dumping data for table data_process.roles: ~3 rows (approximately)
DELETE FROM `roles`;
...
INSERT INTO `roles` (`roleId`, `producerId`, `enumKey`, `roleName`, `roleShortName`, `roleLongName`, `description`, `roleType`, `createdBy`, `createdDate`, `modifiedBy`, `modifiedDate`, `status`, `isAdminRole`) VALUES
	...
	('Employee', 'PRD000001', 'EmployeeRole', 'Employee Role', 'Employee Role', 'Employeeistrator Role', 'Employee Role', 'EmployeeRole', 'PRDADM0001', '2021-01-01 00:00:00', 'PRDADM0001', '2021-01-01 00:00:00', b'1', b'0');
...
-- Dumping data for table data_process.sequence: ~1 rows (approximately)
...
INSERT INTO `userroles` (`autoId`, `employeeId`, `roleId`) VALUES
	(1, 'USR1513438024799', 'Administrator'),
